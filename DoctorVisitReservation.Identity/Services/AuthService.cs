...
public class AuthService : IAuthService
{
    ...
    public async Task<RegistrationResponse> RegisterPatient(RegistrationRequest request)
    {
    ...
    public async Task<RegistrationResponse> RegisterDoctor(RegistrationRequest request)
    {
        var user = new ApplicationUser
        {
            Email = request.Email,
